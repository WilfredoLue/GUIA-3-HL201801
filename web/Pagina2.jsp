...
<html>
    ...
    <body>
        ...
        %>
        <form name="forming" action="ControllerImagen" method="post" enctype="multipart/form-data">
            <div class="datagrid">
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td><label for="id">Nombre del archivo: </label></td>
                            <td><input type="text" name="txtname" value="<c:out value="${row.nombreimg}"/>"/></td>
                        </tr>
                        <tr class="alt">
                            <td>
